...
class ChatSessionView(APIView):
    ...
    def patch(self, request, *args, **kwargs): # https://stackoverflow.com/questions/28459418/rest-api-put-vs-patch-with-real-life-examples
        """Add a user to a chat session."""    # how to use patch
        User = get_user_model()
...
class ChatSessionMessageView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        notif_mess = {'user': deserialize_user(user), 'message': message}
        ...
        notif_args = {
            ...
            'short_description': 'New message', 'silent': True,
            'extra_data': {'uri': chat_session.uri, 'message': notif_mess},
        }
        notify.send(
